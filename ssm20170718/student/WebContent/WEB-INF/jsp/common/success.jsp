...
<body>
<div style="text-align:center;padding:50px 0;margin-top: 20px;" class="bg-success">
	<div>
		<span style="font-size:100px;" class="text-success"><span class="glyphicon glyphicon-ok"></span></span>
		<span style="position: relative; top: -20px;" class="h3">${msg }操作成功！</span>
	</div>
